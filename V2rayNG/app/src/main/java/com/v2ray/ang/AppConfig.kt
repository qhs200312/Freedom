...
object AppConfig {
    ...
    const val PREF_ROOT_PROXY_MODE = "pref_root_proxy_mode"
    ...
    const val PREF_UPDATE_SUBSCRIPTION_ON_START = "pref_update_subscription_on_start"
    ...
    const val APP_URL = "$GITHUB_URL/qhs200312/Freedom"
    const val APP_API_URL = "https://api.github.com/repos/qhs200312/Freedom/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/qhs200312/Freedom/master/CR.md"
    ...
    const val MSG_TRAFFIC_UPDATE = 75
    ...
    const val ROOT_TPROXY_CHAIN = "CORE_TPROXY"
    const val ROOT_TPROXY_DIVERT_CHAIN = "CORE_DIVERT"
    const val ROOT_TPROXY_PORT = 12346
